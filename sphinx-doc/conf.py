...
htmlhelp_basename = "mfd_code_quality"
...
latex_documents = [
    (
        master_doc,
        "mfd_code_quality.tex",
        "MFD Code Quality Documentation",
        "author",
        "manual",
    ),
]
...
man_pages = [(master_doc, "mfd_code_quality", "MFD Code Quality Documentation", [author], 1)]
